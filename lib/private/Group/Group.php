...
class Group implements IGroup {
	...
	public function inGroup($user) {
		return $this->membershipManager->isGroupUserById($user->getID(), $this->backendGroup->getId());
	}
	...
	public function addUser($user) {
		...
		$result = $this->membershipManager->addGroupUser($user->getID(), $this->backendGroup->getId());
	...
	public function removeUser($user) {
		...
		$result = $this->membershipManager->removeGroupUser($user->getID(), $this->backendGroup->getId());
